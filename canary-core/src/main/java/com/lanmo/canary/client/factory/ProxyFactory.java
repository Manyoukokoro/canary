...
import com.lanmo.canary.spring.api.RequestMethod;
...
public class ProxyFactory {
    ...
    public static  <T> T buildProxy(Class<T> tClass, Client client) throws Exception {
        ...
        String key = client.getReferenceConfig().getInterfaceId()+"/"+client.getReferenceConfig().getAlias();
        ...
        //add client instance ***** 把这个client成员变量值 添加到 相应的实体中
    ...
    private static void buildMethod(Method method,CtClass cc) throws CannotCompileException {
        ...
        sb.append(ReferenceConfig.class.getCanonicalName()).append(" newReferenceConfig = new ")
                .append(ReferenceConfig.class.getCanonicalName()).append("();");
        sb.append("newReferenceConfig.setInterfaceId(client.getReferenceConfig().getInterfaceId());");
        sb.append("newReferenceConfig.setAlias(client.getReferenceConfig().getAlias());");
        sb.append("newReferenceConfig.setRequestMethod(requestDetail);");
        sb.append(RequestMsg.class.getCanonicalName()).append(" requestMsg = ")
                .append(RequestFactory.class.getCanonicalName()).append(".buildRequest(newReferenceConfig);");
